    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="min-h-screen flex items-center justify-center px-6 pt-14 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative">
          ...
          <p className="text-xl md:text-2xl font-medium mb-6 bg-gradient-to-r from-[#34d399] to-[#2dd4bf] bg-clip-text text-transparent">
      ...
      <section className="py-20 px-6 bg-white/[0.015]">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-sm font-mono text-emerald-400/70 uppercase tracking-widest font-medium">Features</span>
